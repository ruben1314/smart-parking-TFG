...
with tf.Session() as sess:
    ...
    for indiceImagen in os.listdir(args.input_image):
	    ...
	    if(0):
		    ic.pixel_intensity(boxes_, img_ori)
		    ic.corners_intensity(boxes_,img_ori)
		    ic.full_box(boxes_,img_ori)
		    ic.little_box(boxes_,img_ori)



	    subprocess.Popen(['python3', '../../space_gap.py',str(boxes_), '../../Redes/monoResMatch-Tensorflow-master/output/disp/raw/'+image_name+'.png',str(labels_)])
