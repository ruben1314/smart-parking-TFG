...
#restore_path = './checkpoint/best_model_Epoch_42_step_10878_mAP_0.0611_loss_11.6598_lr_3e-05'  # The path of the weights to restore.
...
nms_topk = 10  # keep at most nms_topk outputs after nms
# mAP eval
