...
if(args.video):
	...
	os.chdir("./Redes/YOLOv3_TensorFlow-master/")
	subprocess.call(["python3", "test_single_image_automatico_without_depth.py", "../../output/"+name_path+"/"])


elif(args.folder):
		
	os.chdir("./Redes/YOLOv3_TensorFlow-master/")
	subprocess.call(["python3", "test_single_image_automatico_without_depth.py", path])
